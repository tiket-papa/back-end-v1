...
interface verifyEmailatributes {
  html: string
  text: string
}

export const verifyEmailTemplate = function (link: string): verifyEmailatributes {
  const html = `
  <!DOCTYPE html>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          cellspacing="0" role="presentation">
                            <tr >
                              <td align="center">
                                <a href="${link}" style="display: inline-block; background: #1c5e7b; padding: 10px 20px; border-radius: 10px; text-decoration: none; cursor: pointer; color: white;" >Verify Email Address</a>
                              </td>
                            </tr>
                          </table>
